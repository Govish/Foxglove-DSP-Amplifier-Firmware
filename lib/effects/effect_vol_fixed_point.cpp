...
const Effect_Icon_t Effect_Vol_Fixed_Point::icon = {
    ...
    0x01, 0x00, 0x00, 0x04, 0x01, 0x70, 0x00, 0x04, 0x01, 0x70, 0x00, 0x04, 
    0x01, 0x70, 0x00, 0x04, 0x01, 0x70, 0x00, 0x04, 0x01, 0xF8, 0x00, 0x04, 
    0x01, 0xFC, 0x01, 0x04, 0x01, 0x06, 0x03, 0x04, 0x01, 0x06, 0x03, 0x04, 
    0x01, 0x06, 0x03, 0x04, 0x01, 0x06, 0x03, 0x04, 0x01, 0x06, 0x03, 0x04, 
    0x01, 0xFC, 0x01, 0x04, 0x01, 0xF8, 0x00, 0x04, 0x01, 0x70, 0x00, 0x04, 
...
void Effect_Vol_Fixed_Point::audio_update(const Audio_Block_t& block_in, Audio_Block_t& block_out) {
    ...
    for(size_t i = 0; i < block_in.size(); i++) {
        ...
        */
        int32_t vol_adj_sample = signed_multiply_32x16b(vol_fp, sample_in);
