...
class Effect_IIR_HP : public Effect_Interface {
public:
    ...
    Effect_IIR_HP(const Effect_IIR_HP& other);
...
private:
    ...
    int32_t lp_last_output = 0;        //single output memory element for our first-order IIR filter
